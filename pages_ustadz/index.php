...
if (!isset($_SESSION['users']) || $_SESSION['level'] != 'ustadz') {
    ...
    <nav class="navbar navbar-custom">
        ...
        <i id="sidebar-toggle" class="bi bi-list fs-3 me-3" style="cursor:pointer;"></i>
            <div class="d-flex align-items-center gap-3">
                <span class="navbar-brand">Pengguna Uztadz</span>
            </div>
        ...
        <div class="sidebar-wrapper">
            <nav>
                <ul class="nav sidebar-menu flex-column">
                    <li class="nav-item">
                        <a href="?p=dashboard_ustadz" class="nav-link">
                            <i class="nav-icon bi bi-speedometer"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="?p=tambah_data_ustadz" class="nav-link">
                            <i class="nav-icon bi bi-plus-circle-fill fs-4"></i>
                            <p>Tambah Data</p>
                        </a>
                    </li>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li><a href="?p=data_yanbu_ustadz" class="nav-link"><i class="nav-icon bi bi-person-lines-fill"></i> Data Yanbu'a</a></li>
                            <li><a href="?p=data_juzama_ustadz" class="nav-link"><i class="nav-icon bi bi-book-half"></i> Data Juz'ama</a></li>
                            <li><a href="?p=data_alquran_ustadz" class="nav-link"><i class="nav-icon bi bi-journal-text"></i> Data Al Qur'an</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
...
<footer class="app-footer text-center p-2">
    <strong>&copy; 2024 SantriPro.</strong>
</footer>
