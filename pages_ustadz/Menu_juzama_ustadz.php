...
if ($keyword != "") {
    ...
    if ($column) {
        $query = "SELECT * FROM juzama WHERE $column LIKE '%$safe_keyword%' ORDER BY id DESC";
    }
}
...
<head>
    ...
    <style>
        ...
        /* Menggunakan style top-card yang sudah ada untuk tombol Tambah Data */
        .btn-add {
...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="tambah_data_juzama_ustadz.php" class="btn-add">
    ...
    <form method="post" class="d-flex gap-2 mb-3">
        ...
        <a href="?p=data_juzama_ustadz" class="btn btn-secondary">Reset</a>
    </form>
...
?>
    <tr>
        ...
        <td>
            <a href="edit_data_juzama_ustadz.php?id=<?= $row['id']; ?>" class="btn-action-edit btn-sm me-1" title="Edit Data">
                <i class="fa fa-edit"></i>
            </a>
            <a href="hapus_data_juzama_ustadz.php?id=<?= $row['id']; ?>" class="btn-action-delete btn-sm" title="Hapus Data" onclick="return confirm('Yakin ingin menghapus data ini?');">
