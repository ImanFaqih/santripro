...
<head>
    ...
    <style>
        ...
        /* Tambahan/Perbaikan CSS untuk Tombol Aksi */
        .btn-add {
...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="tambah_data_yanbu_admin.php" class="btn-add">
    ...
    <select name="category" class="form-select" style="max-width:200px;">
        ...
        <a href="?p=data_yanbu_admin" class="btn btn-secondary">Reset</a>
    </form>
...
?>
    <tr>
        ...
        <td>
            <a href="edit_data_yanbu_admin.php?id=<?= $row['id']; ?>" class="btn-action-edit btn-sm me-1" title="Edit Data">
                <i class="fa fa-edit"></i>
            </a>
            <a href="hapus_data_yanbu_admin.php?id=<?= $row['id']; ?>" class="btn-action-delete btn-sm" title="Hapus Data" onclick="return confirm('Yakin ingin menghapus data ini?');">
