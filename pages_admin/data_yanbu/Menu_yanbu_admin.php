...
?>
    <tr>
        ...
        <td>
            ...
            <a href="?p=detail_data_yanbu_admin&id=<?= $row['id']; ?>" class="btn btn-info btn-sm text-white">
                <i class="fa fa-eye"></i>
            </a>


            <a href="?p=edit_data_yanbu_admin&id=<?= $row['id']; ?>" class="btn-action-edit">
                <i class="fa fa-edit"></i>
            </a>

            <a href="?p=hapus_data_yanbu_admin&id=<?= $row['id']; ?>" class="btn-action-delete">
