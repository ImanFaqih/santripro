    ...
    <nav class="navbar navbar-custom">
        ...
        <i id="sidebar-toggle" class="bi bi-list fs-3 me-3" style="cursor:pointer;"></i>
            <div class="d-flex align-items-center gap-3">
                <span class="navbar-brand">Pengguna Admin</span>
            </div>
...
<div class="app-wrapper">
    ...
    <aside class="app-sidebar custom-sidebar shadow" data-bs-theme="dark">
        <div class="sidebar-brand">
            <a href="?p=dashboard_admin" class="brand-link">
        ...
        <div class="sidebar-wrapper">
            <nav>
                <ul class="nav sidebar-menu flex-column">
                    <li class="nav-item">
                        <a href="?p=dashboard_admin" class="nav-link">
                            <i class="nav-icon bi bi-speedometer"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                        <li class="nav-item">
                        <a href="?p=approve" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li><a href="?p=data_yanbu_admin" class="nav-link"><i class="nav-icon bi bi-person-lines-fill"></i> Data Yanbu'a</a></li>
                            <li><a href="?p=data_juzama_admin" class="nav-link"><i class="nav-icon bi bi-book-half"></i> Data Juz'ama</a></li>
                            <li><a href="?p=data_alquran_admin" class="nav-link"><i class="nav-icon bi bi-journal-text"></i> Data Al Qur'an</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
