...
<head>
    ...
    <title>Menu Data Al-Qur'an</title>
...
<div class="container mt-4">
    ...
    <div class="top-card mb-3">
        ...
        <a href="?p=tambah_data_alquran_admin" class="btn-add">
...
?>
    <tr>
        ...
        <td>
            ...
            <a href="?p=detail_data_alquran_admin&id=<?= $row['id']; ?>" class="btn btn-info btn-sm text-white">
                <i class="fa fa-eye"></i>
            </a>


            <a href="?p=edit_data_alquran_admin&id=<?= $row['id']; ?>" class="btn-action-edit">
                <i class="fa fa-edit"></i>
            </a>

            <a href="?p=hapus_data_alquran_admin&id=<?= $row['id']; ?>" class="btn-action-delete">
