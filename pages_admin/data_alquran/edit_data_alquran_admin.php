        ...
        <tr>
            ...
            <td>
                <select name="nama_ustadz" class="form-control" required>
                    ...
                    <option value="Syafiqul Umam"   <?= $row['nama_ustadz']=='Syafiqul Umam'?'selected':'' ?>>Syafiqul Umam</option>
                    <option value="Nazila Umi Syarifah"  <?= $row['nama_ustadz']=='Nazila Umi Syarifah'?'selected':'' ?>>Nazila Umi Syarifah</option>
                    <option value="Ariqoh Nadif"  <?= $row['nama_ustadz']=='Ariqoh Nadif'?'selected':'' ?>>Ariqoh Nadif</option>
                </select>
            </td>
        </tr>
